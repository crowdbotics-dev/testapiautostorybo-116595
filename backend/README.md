...
## Project Structure
    ...
    ├── testapiautostorybo_116595  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_116595`
...
2. Clone this repo and `cd testapiautostorybo_116595`
